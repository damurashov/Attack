...
def LKT_intialization(first_frame, template, bbox, 
    ...
    # ShiTomasi corner detection 
    first_frame_corners = find_Shi_Tomasi_corners(np.copy(first_frame), maxCorners=maxCorners, qualityLevel=qualityLevel, minDistance=minDistance, blockSize=blockSize)
